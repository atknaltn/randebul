...
class MyProfilePro extends StatefulWidget {
  const MyProfilePro(
      {Key? key})
      : super(key: key);
  @override
  State<MyProfilePro> createState() => _MyProfileProState();
}

class _MyProfileProState extends State<MyProfilePro> {
              ...
              children: [
                ...
                Expanded(
                  child: GestureDetector(
                      ...
                      child: const IconText(
                          icon: Icons.create_new_folder, text: 'Create Service')),
                ),
              ],
            ),
          ),
